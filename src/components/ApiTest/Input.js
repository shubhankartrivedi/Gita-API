  ...
  return (
    <div className='flex flex-col h-full justify-end gap-5 md:pr-5'>
      ...
      <div className='flex flex-col w-full'>
        ...
        <button onClick={handleSend} className='flex animate-fade-in-simple justify-center px-3 py-1 dark:bg-yellow-900 dark:text-yellow-400 dark:hover:bg-yellow-800 bg-yellow-500 text-yellow-800 hover:bg-yellow-400 rounded-md text-md overflow-hidden'>
          {loading ?
            <div className='animate-fade-in-simple '>
              <ReactLoading type='spin' color={!theme ? '#854d0e' : '#facc15'} height={30} width={30} />
            </div>
            :
            <div sclassName={`flex gap-2`}>
